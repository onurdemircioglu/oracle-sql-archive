SELECT SYSDATE AS SYSTEM_DATE
        ...
        ,TO_CHAR(SYSDATE, 'YMM') AS DATE_FORMAT_YMM
        ,LAST_DAY(TO_DATE(TO_CHAR(SYSDATE,'YMM'), 'YMM')) AS DATE_FORMAT_YMM_REVERSE
        ,TO_CHAR(SYSDATE, 'YMMDD') AS DATE_FORMAT_YMMDD
        ,LAST_DAY(TO_DATE(TO_CHAR(SYSDATE,'YMMDD'), 'YMMDD')) AS DATE_FORMAT_YMMDD_REVERSE
FROM DUAL
;
