SELECT SYSDATE AS SYSTEM_DATE
        ...
        ,TO_DATE(2021 || '08' || '02', 'YYYYMMDD') AS DATE_FORMAT_07 -- IF YOU HAVE VALUES YOU CAN CREATE DATE WITH FORMAT
        ...
        ,EXTRACT(YEAR FROM SYSDATE) || '-Q' || TO_CHAR(SYSDATE, 'Q') AS QUARTER
        ...
        ,TO_CHAR(SYSDATE, 'MONTH', 'NLS_DATE_LANGUAGE = TURKISH') AS MONTH_NAME_LOCAL
