SELECT SYSDATE AS SYSTEM_DATE
        ...
        ,TO_CHAR(SYSDATE, 'DD-MM-YYYY HH24:MI:SS') AS DATE_FORMAT_01 -- DATE WITH TIME FORMAT
        ,TO_CHAR(SYSDATE, 'DDMMYYYY') AS DATE_FORMAT_02 -- MY FAVORITE FORMAT
        ,TO_CHAR(SYSDATE, 'YYYYMMDD') AS DATE_FORMAT_03 -- MY SECOND FAVORITE FORMAT
        ...
        ,TO_DATE(2021 || LPAD('08',2,0) || LPAD('02',2,0), 'YYYYMMDD') AS DATE_FORMAT_07 -- IF YOU REPLACE 2021, 08 AND 02 WITH YEAR, MONTH AND DAY VALUES YOU CAN CREATE DATE
